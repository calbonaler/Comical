...
namespace Comical.Core.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   クラスは読み取り専用であるため変更できません。 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string CannotModifyClassInReadOnlyMode {
            get {
                return ResourceManager.GetString("CannotModifyClassInReadOnlyMode", resourceCulture);
            }
        }
